...
import 'dart:async';
import '../view/screens/events_detail_screen.dart';
...
class DeepLinkService {
  ...
  void _handleEventDeepLink(List<String> segments) {
    if (segments.length < 2) return;

    final String eventId = segments[1];
    _navigateDebouncer.call(() {
      Get.toNamed(
        EventsDetailScreen.routeName,
        arguments: {"slug": eventId},
      );
    });
  }
